            ...
            <div class="card border-0 shadow components-section">
                <div class="card-body">
                    <form action="{{ route('pelanggan.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="gender" name="gender" class="form-select">
                                        ...
                                        <option value="Lain-lain" {{ old('gender') == 'Lain-lain' ? 'selected' : '' }}>
                                            Lain-lain</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h5 class="mb-3">Upload File (Opsional)</h5>
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Format: JPG, JPEG, PNG, PDF, DOC, DOCX (Max: 20MB per
                                        file)</small>
                                    @error('files.*')
